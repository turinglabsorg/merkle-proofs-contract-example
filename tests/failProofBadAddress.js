    ...
    if (configs.owner_mnemonic !== undefined) {
        ...
        try {
            ...
            if (storedRoot === calculatedRoot) {
                const proof = tree.getHexProof(keccak256("0xaF79c3b6b5d6A40B9234f5a791Ad110b03f3C947"))
                console.log(proof)
                const result = await nftContract.methods.verifyProof("0xaF79c3b6b5d6A40B9234f5a791Ad110b03f3C947", proof).call()
                console.log(result);
            } else {
